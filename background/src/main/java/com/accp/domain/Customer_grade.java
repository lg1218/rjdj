...
public class Customer_grade {
    ...
    private String cgAuditing;

    private String cgYn;

    private String cgCustom1;

    private String cgCustom2;

    private String cgCustom3;

    private String cgCustom4;

    private String cgCustom5;

    private String cgCustom6;
