...
public class DullSection {
    private String dsId;

    private Integer dsStartday;

    private Integer dsEnddate;

    private String dsDecoration;

    private String dsAuditing;

    private String dsYn;

    private String dsCustom1;

    private String dsCustom2;

    private String dsCustom3;

    private String dsCustom4;

    private String dsCustom5;

    private String dsCustom6;
    ...
    public void setDsDecoration(String dsDecoration) {
        this.dsDecoration = dsDecoration;
    }
