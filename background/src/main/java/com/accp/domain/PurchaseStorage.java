...
public class PurchaseStorage {
    ...
    @JsonFormat(pattern = "yyyy-MM-dd")  //出的时候
    ...
    public PurchaseStorageType getPurchaseStorageType() {
        return purchaseStorageType;
    }

    public void setPurchaseStorageType(PurchaseStorageType purchaseStorageType) {
    ...
    //采购入库主表关联了四个表
    private Supplier supplier; //一对一的供应商
    private PurchaseStorageType purchaseStorageType; //一对一的采购入库类型
    private Warehouse warehouse; //一对一的仓库
    private Currency currency;  //一对一的币别
    private List<PurchaseStorageDetailed> purchaseStorageDetaileds; //一对多的入库详表

    public List<PurchaseStorageDetailed> getPurchaseStorageDetaileds() {
        return purchaseStorageDetaileds;
    }

    public void setPurchaseStorageDetaileds(List<PurchaseStorageDetailed> purchaseStorageDetaileds) {
        this.purchaseStorageDetaileds = purchaseStorageDetaileds;
    }
}
