...
public class AssessmentProcurementFruit {
    ...
    private String apfMatterId;

    private String apfMatterName;

    private String apfSpecifications;

    private String apfCompanyName;

    private Integer apfAmount;

    private Float apfMoney;

    private Float apfWeight;

    private Float apfVolumeWood;

    private Float apfContribution;

    private String prtAudition;

    private String prtYn;

    private String prtCustom1;

    private String prtCustom2;

    private String prtCustom3;

    private String prtCustom4;

    private String prtCustom5;

    private String prtCustom6;
    ...
    public void setApfMatterName(String apfMatterName) {
        this.apfMatterName = apfMatterName;
    }
    ...
    public void setApfSpecifications(String apfSpecifications) {
        this.apfSpecifications = apfSpecifications;
    }
    ...
    public void setApfCompanyName(String apfCompanyName) {
        this.apfCompanyName = apfCompanyName;
    }
