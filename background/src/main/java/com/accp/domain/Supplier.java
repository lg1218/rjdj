...
public class Supplier {
    ...
    private String supplierEasyname;

    private String supplierEngname;

    private String supplierEasyengname;

    private String supplierAccountAttribution;
    ...
    private String supplierPrincipalman;

    private String supplierLinkman;

    private String supplierLinktela;

    private String supplierLinktelb;

    private String supplierLinktelc;
    ...
    private String supplierProcurementStaff;

    private String supplierTaxcheckno;

    private Float supplierCapitalmoney;

    private String supplierJob;

    private String supplierEmail;

    private String supplierWebadd;

    private String supplierFaxno;

    private Date supplierCufirstsaleinput;

    private Date supplierCufirstsalereturn;

    private Date supplierCurecentsaleinput;

    private Date supplierCurecentsalereturn;

    private String supplierTaxIncluded;

    private Date supplierTerminationdate;

    private Float supplierCreditmoney;

    private Float supplierResiduemonet;

    private String supplierCondition;

    private Date supplierCuendorderday;

    private String supplierHonestlv;

    private String supplierInvoiceType;

    private Float supplierCufirstcollect;

    private Float supplierHouldcollect;

    private Float supplierCuendcollect;

    private Float supplierCuendshouldcollect;

    private String supplierCudecoration;

    private Integer supplierCollectiontermid;

    private Integer supplierInvoicetypeid;

    private Integer supplierHouldcollectmoney;

    private Integer supplierCurecollectmoney;

    private String supplierAddressNo;

    private String supplierRemark;

    private String supplierAuditing;

    private String supplierYn;

    private String supplierCustom1;

    private String supplierCustom2;

    private String supplierCustom3;

    private String supplierCustom4;

    private String supplierCustom5;

    private String supplierCustom6;
    ...
    public void setSupplierEasyname(String supplierEasyname) {
        this.supplierEasyname = supplierEasyname;
    }
    ...
    public void setSupplierEasyengname(String supplierEasyengname) {
        this.supplierEasyengname = supplierEasyengname;
    }
    ...
    public void setSupplierAccountAttribution(String supplierAccountAttribution) {
        this.supplierAccountAttribution = supplierAccountAttribution;
    }
    ...
    public void setSupplierPrincipalman(String supplierPrincipalman) {
        this.supplierPrincipalman = supplierPrincipalman;
    }
    ...
    public void setSupplierLinktela(String supplierLinktela) {
        this.supplierLinktela = supplierLinktela;
    }
    ...
    public void setSupplierLinktelb(String supplierLinktelb) {
        this.supplierLinktelb = supplierLinktelb;
    }
    ...
    public void setSupplierLinktelc(String supplierLinktelc) {
        this.supplierLinktelc = supplierLinktelc;
    }
    ...
    public void setSupplierProcurementStaff(String supplierProcurementStaff) {
        this.supplierProcurementStaff = supplierProcurementStaff;
    }
    ...
    public void setSupplierTaxcheckno(String supplierTaxcheckno) {
        this.supplierTaxcheckno = supplierTaxcheckno;
    }
    ...
    public void setSupplierWebadd(String supplierWebadd) {
        this.supplierWebadd = supplierWebadd;
    }
    ...
    public void setSupplierTaxIncluded(String supplierTaxIncluded) {
        this.supplierTaxIncluded = supplierTaxIncluded;
    }
    ...
    public void setSupplierHonestlv(String supplierHonestlv) {
        this.supplierHonestlv = supplierHonestlv;
    }
    ...
    public void setSupplierCudecoration(String supplierCudecoration) {
        this.supplierCudecoration = supplierCudecoration;
    }
    ...
    public void setSupplierAddressNo(String supplierAddressNo) {
        this.supplierAddressNo = supplierAddressNo;
    }
    ...
    public void setSupplierAuditing(String supplierAuditing) {
        this.supplierAuditing = supplierAuditing;
    }
    ...
    public void setSupplierCustom1(String supplierCustom1) {
        this.supplierCustom1 = supplierCustom1;
    }
    ...
    public void setSupplierCustom2(String supplierCustom2) {
        this.supplierCustom2 = supplierCustom2;
    }
    ...
    public void setSupplierCustom3(String supplierCustom3) {
        this.supplierCustom3 = supplierCustom3;
    }
    ...
    public void setSupplierCustom4(String supplierCustom4) {
        this.supplierCustom4 = supplierCustom4;
    }
    ...
    public void setSupplierCustom5(String supplierCustom5) {
        this.supplierCustom5 = supplierCustom5;
    }
    ...
    public void setSupplierCustom6(String supplierCustom6) {
        this.supplierCustom6 = supplierCustom6;
    }
}