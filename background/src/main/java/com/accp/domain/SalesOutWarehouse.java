...
public class SalesOutWarehouse {
    ...
    private String sowCustom4;

    private String sowCustom5;

    private String sowCustom6;
    
    private List<SalesOutWarehouseDetailed> sowd;
    

    public List<SalesOutWarehouseDetailed> getSowd() {
		return sowd;
	}

	public void setSowd(List<SalesOutWarehouseDetailed> sowd) {
		this.sowd = sowd;
	}
