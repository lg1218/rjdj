...
public class Material_type {
    ...
    private String mtEnglishName;

    private String mtSaveSubject;

    private String mtSubjectA;

    private String mtSubjectB;

    private String mtSubjectC;

    private String mtSaleinSubject;

    private String mtSalecostSubject;

    private String mtOtherinSubject;

    private String mtOthercostSubject;

    private String mtOthersellSubject;

    private String mtOthersendSubject;

    private String mtRemark;

    private String mtAuditing;

    private String mtYn;

    private String mtCustom1;

    private String mtCustom2;

    private String mtCustom3;

    private String mtCustom4;

    private String mtCustom5;

    private String mtCustom6;
