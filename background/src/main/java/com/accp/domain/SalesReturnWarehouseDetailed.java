...
public class SalesReturnWarehouseDetailed {
    private String srwdId;

    private String srwId;

    private String matterId;

    private String srwdEngname;

    private String srwdRemark;

    private String srwdPriceIncludeTax;

    private Integer srwdSingleStatus;

    private Date srwdDocumentDate;

    private Float srwdDocumentNumber;

    private Float srwdPrice;

    private Float srwdMoney;

    private Float srwdTaxRate;

    private Float srwdTaxAmount;

    private Float srwdIncludingTaxAmount;

    private String srwdBatchNumber;

    private String srwdIfgift;

    private String srwdInvoiceDetails;

    private Integer srwdNomakeInvoiceNum;

    private String srwdRemarks;

    private String srwdSourceOrder;

    private String srwdSourceNo;

    private String srwdAuditing;

    private String srwdYn;

    private String srwdCustom1;

    private String srwdCustom2;

    private String srwdCustom3;

    private String srwdCustom4;

    private String srwdCustom5;

    private String srwdCustom6;
    ...
    public void setSrwdPriceIncludeTax(String srwdPriceIncludeTax) {
        this.srwdPriceIncludeTax = srwdPriceIncludeTax;
    }
    ...
    public void setSrwdBatchNumber(String srwdBatchNumber) {
        this.srwdBatchNumber = srwdBatchNumber;
    }
    ...
    public void setSrwdInvoiceDetails(String srwdInvoiceDetails) {
        this.srwdInvoiceDetails = srwdInvoiceDetails;
    }
    ...
    public void setSrwdSourceOrder(String srwdSourceOrder) {
        this.srwdSourceOrder = srwdSourceOrder;
    }
    ...
    public void setSrwdSourceNo(String srwdSourceNo) {
        this.srwdSourceNo = srwdSourceNo;
    }
    ...
    public void setSrwdAuditing(String srwdAuditing) {
        this.srwdAuditing = srwdAuditing;
    }
