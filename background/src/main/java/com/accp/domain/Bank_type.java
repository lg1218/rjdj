...
public class Bank_type {
    ...
    private String btEnglishName;

    private String btRemark;

    private String btAuditing;

    private String btYn;

    private String btCustom1;

    private String btCustom2;

    private String btCustom3;

    private String btCustom4;

    private String btCustom5;

    private String btCustom6;
