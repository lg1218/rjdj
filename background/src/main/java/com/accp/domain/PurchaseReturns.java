...
public class PurchaseReturns {
    ...
    private String pureEngname;

    private String puretId;

    private String purePriceIncludeTax;

    private Integer warehouseId;

    private String pureSingleStatus;

    private Date pureDocumentDate;

    private String pureDocumentNumber;

    private String currencyId;

    private Float pureExchangeRate;

    private Integer pureForeignTrade;

    private Integer pureSunnum;

    private Float pureSunmoney;

    private Float pureTax;

    private Float pureIncludeTaxAmount;

    private String pureDeliveryAddress;

    private String pureBuyer;

    private String pureBelongsSection;

    private String pureBelongsProject;

    private String pureExecutor;

    private String pureCheckagainStaff;

    private String pureHeaderProvision;

    private String pureEndClause;

    private String pureRemark;

    private String pureAudition;

    private String pureYn;

    private String pureCustom1;

    private String pureCustom2;

    private String pureCustom3;

    private String pureCustom4;

    private String pureCustom5;

    private String pureCustom6;
