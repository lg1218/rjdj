...
public class ReceivableDetail {
    ...
    private String padeSourcelist;

    private Date padeSourcetime;

    private String padeSourcenumber;

    private String padeInvoiceno;

    private String padeTransaction;

    private String padeTransactionname;

    private String padeTeamName;

    private String padeStaffName;

    private String padeProjectName;

    private String padeCurrencyName;

    private Integer padeCurrencyInexchange;

    private Float padePrice;

    private Float padeCurrentbalance;

    private Float padeDiscountamount;

    private Float padeAmountcharged;

    private Float padeOffsetamount;

    private String padeAuditing;

    private String padeYn;

    private String padeCustom1;

    private String padeCustom2;

    private String padeCustom3;

    private String padeCustom4;

    private String padeCustom5;

    private String padeCustom6;

    private String padeCustom7;

    private String padeCustom8;

    private String padeCustom9;

    private String padeCustom10;

    public String getReedetailId() {
        return reedetailId;
    }

    public void setReedetailId(String reedetailId) {
        this.reedetailId = reedetailId;
    }
    ...
    public void setPadeSourcelist(String padeSourcelist) {
        this.padeSourcelist = padeSourcelist;
    }
    ...
    public void setPadeSourcenumber(String padeSourcenumber) {
        this.padeSourcenumber = padeSourcenumber;
    }
    ...
    public void setPadeInvoiceno(String padeInvoiceno) {
        this.padeInvoiceno = padeInvoiceno;
    }
    ...
    public void setPadeTransaction(String padeTransaction) {
        this.padeTransaction = padeTransaction;
    }
    ...
    public void setPadeTransactionname(String padeTransactionname) {
        this.padeTransactionname = padeTransactionname;
    }
    ...
    public void setPadeTeamName(String padeTeamName) {
        this.padeTeamName = padeTeamName;
    }
    ...
    public void setPadeStaffName(String padeStaffName) {
        this.padeStaffName = padeStaffName;
    }
    ...
    public void setPadeProjectName(String padeProjectName) {
        this.padeProjectName = padeProjectName;
    }
    ...
    public void setPadeCurrencyName(String padeCurrencyName) {
        this.padeCurrencyName = padeCurrencyName;
    }
    ...
    public void setPadeAuditing(String padeAuditing) {
        this.padeAuditing = padeAuditing;
    }
    ...
    public void setPadeCustom10(String padeCustom10) {
        this.padeCustom10 = padeCustom10;
    }
}